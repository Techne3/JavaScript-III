...
*/
      ...
      function CharacterStats (at){
        GameObject.call(this,at)
...
*/
function Humanoid(at){
  CharacterStats.call( this, at)
  // GameObject.call(this,at)
  this.team = at.team;
...
console.log(Villain.prototype.battle())
...
console.log(Hero.prototype.attack())